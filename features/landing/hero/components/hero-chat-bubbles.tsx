  ...
  return (
    <>
      ...
      >
        <ChatBubbleIcon
          aria-hidden="true"
          className="h-[39px] w-[80px] drop-shadow-[0_5px_7px_rgba(0,0,0,0.1)]"
      ...
      <motion.div
        className="absolute left-[17%] top-[76px]"
        animate={chatBubbleMotion.animate}
        transition={{ ...chatBubbleMotion.transition, delay: 0.25 }}
      >
        <ChatBubbleIcon
          aria-hidden="true"
          className="h-[34px] w-[72px] -scale-x-100 drop-shadow-[0_5px_7px_rgba(0,0,0,0.08)]"
